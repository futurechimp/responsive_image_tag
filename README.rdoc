...
If you're using Padrino, make sure you put this *underneath* the `gem 'padrino'`.
...
In order for the JavaScript image replacement to happen, you need to put this in a `document.ready()` (or use something like require.js to accomplish the same thing).
