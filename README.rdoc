...
In order for the JavaScript image replacement to happen, you need to put the following mehtod call in a <tt>$(document).ready()</tt> block or where ever you are.
